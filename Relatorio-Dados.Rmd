...
b1_ic_string <- paste("[",round(b1_ic[1],3),",",round(b1_ic[2],3),"]")
# b2
b2_ic <- c(b2-z*ASE2,b2+z*ASE2)
b2_ic_string <- paste("[",round(b2_ic[1],3),",",round(b2_ic[2],3),"]")

# b3
b3_ic <- c(b3-z*ASE3,b3+z*ASE3)
b3_ic_string <- paste("[",round(b3_ic[1],3),",",round(b3_ic[2],3),"]")


# Intervalos para odds

odds_b1 <- exp(b1_ic)
odds_b1_string <- paste("[",round(odds_b1[1],3),",",round(odds_b1[2],3),"]")
odds_b2 <- exp(b2_ic)
odds_b2_string <- paste("[",round(odds_b2[1],3),",",round(odds_b2[2],3),"]")
odds_b3 <- exp(b3_ic)
odds_b3_string <- paste("[",round(odds_b3[1],3),",",round(odds_b3[2],3),"]")
...
tbl_intervalos_betas_odds %>% 
  kableExtra::kbl(.,digits=3,align=c('l','c','c'),booktabs = T,
