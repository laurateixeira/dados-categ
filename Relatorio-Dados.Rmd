...
```{r}
log_multipla_BIC <- log_multipla %>% stepAIC(trace = F, direction="both", k=log(51))
```
...
Para os dois casos, assume-se que não existe interação entre nível de fofatase ácida e estágio do tumor ou nível de fofatase ácida e resultado da radiografia ou estágio do tumor e resultado da radiografia.
